            ...
            <div className="bg-slate-800/50 rounded-xl p-4 mb-4 border border-slate-700/50">
              ...
              <div className="flex items-center gap-4 mb-3">
                ...
                <button
                  ...
                  className="w-14 h-14 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-amber-500/30 hover:scale-105 hover:shadow-[0_0_20px_rgba(251,191,36,0.5)] transition-all"
                  title="View Profile"
                >
    ...
    >
      ...
      >
        <HelpCircle size={18} />
              ...
              {/* Quick Links - Inside Profile Card */}
              <div className="grid grid-cols-4 gap-2 mt-4 pt-4 border-t border-slate-700/30">
                <button
                  onClick={() => {
                    soundManager.playButtonClick();
                    setShowFriendsList(true);
                  }}
                  className="p-2.5 bg-slate-900/50 rounded-xl text-slate-300 hover:bg-slate-800/70 transition-all flex flex-col items-center justify-center gap-1 border border-slate-700/50 relative"
                >
                ...
                <button
                  ...
                  className="p-2.5 bg-slate-900/50 rounded-xl text-slate-300 hover:bg-slate-800/70 transition-all flex flex-col items-center justify-center gap-1 border border-slate-700/50"
                >
                ...
                >
                  ...
                  <span className="text-[10px]">Spectate</span>
                </button>
                <button
                  onClick={() => {
                    soundManager.playButtonClick();
            ...
            {/* Find Match - Primary CTA (slightly smaller with icon) */}
            <button
              onClick={handleFindMatch}
              className="w-full p-3.5 mb-4 bg-gradient-to-r from-amber-500 to-orange-600 rounded-xl font-bold tracking-wider text-white hover:from-amber-400 hover:to-orange-500 transition-all shadow-[0_0_30px_rgba(251,191,36,0.5)] active:scale-[0.98] flex items-center justify-center gap-2"
            >
              <Swords size={20} />
          ...
          {/* Game Menu button when profile error */}
          {(profileError || (!profile && user)) && (
            <button
              onClick={handleBack}
              className="w-full mt-4 py-3 px-4 rounded-xl font-bold text-base text-slate-300 bg-slate-800/70 hover:bg-slate-700/70 transition-all border border-slate-600/50 hover:border-slate-500/50 flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(100,116,139,0.2)]"
