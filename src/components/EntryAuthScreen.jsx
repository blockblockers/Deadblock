...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, User, AlertCircle, CheckCircle, Loader2, KeyRound, Wand2 } from 'lucide-react';
...
const EntryAuthScreen = ({ onComplete }) => {
  ...
  // Render welcome screen with Google sign-in and options
  if (mode === 'welcome') {
    return (
      <div 
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-cyan-500/30 shadow-[0_0_30px_rgba(34,211,238,0.2)]">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 px-4 bg-white hover:bg-gray-50 text-gray-800 font-semibold rounded-xl flex items-center justify-center gap-3 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50"
            >
              {loading ? (
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 px-4 bg-slate-800 hover:bg-slate-700 text-white font-medium rounded-xl flex items-center justify-center gap-2 transition-all duration-300 border border-slate-700"
              >
                <Mail size={18} />
                Sign in with Email
              </button>
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-gradient-to-r from-purple-600/80 to-pink-600/80 hover:from-purple-600 hover:to-pink-600 text-white font-medium rounded-xl flex items-center justify-center gap-2 transition-all duration-300"
              >
                <Wand2 size={18} />
          ...
          <button
            onClick={handleSkip}
            className="w-full mt-4 py-3 text-slate-500 hover:text-slate-300 text-sm transition-colors flex items-center justify-center gap-2"
          >
            Skip for now
            <ArrowRight size={16} />
          </button>
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-cyan-500/30 shadow-[0_0_30px_rgba(34,211,238,0.2)]">
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all duration-300 shadow-lg disabled:opacity-50"
              >
          ...
          <button
            onClick={() => switchMode('welcome')}
            className="w-full mt-4 py-3 text-slate-500 hover:text-slate-300 text-sm transition-colors"
          >
            ← Back
          </button>
          ...
          <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-cyan-500/30 shadow-[0_0_30px_rgba(34,211,238,0.2)]">
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all duration-300 shadow-lg disabled:opacity-50"
              >
          ...
          <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-purple-500/30 shadow-[0_0_30px_rgba(168,85,247,0.2)]">
            <form onSubmit={handleMagicLink} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all duration-300 shadow-lg disabled:opacity-50"
              >
