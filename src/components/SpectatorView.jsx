        ...
        <div className="flex flex-col items-center">
          <div className="grid grid-cols-8 gap-0.5 sm:gap-1 p-1.5 sm:p-2 rounded-xl border border-slate-500/30" style={{
            ...
            {board.map((row, rowIdx) => row.map((cellValue, colIdx) => {
              ...
              return (
                <div key={`${rowIdx}-${colIdx}`} className={`aspect-square rounded-md sm:rounded-lg relative transition-all duration-300 overflow-hidden ${
                ...
                }`} style={isLastMove ? { background: 'linear-gradient(135deg, #fbbf24, #f59e0b, #d97706)', animation: 'last-move-pulse 2s ease-in-out infinite', boxShadow: '0 0 15px rgba(251,191,36,0.6), inset 0 0 8px rgba(255,255,255,0.3)' } : undefined}>
